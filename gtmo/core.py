...
• **Fail‑fast strict mode** – set env var ``GTM_STRICT=1`` to make any arithmetic
  with Ø or ℓ∅ raise ``SingularityError`` instead of silently absorbing/collapsing.
...
from typing import Any, Final, cast # Added cast
...
# Removed JsonEncodable protocol and _to_json function as to_json is now a method.
# Monkey-patching is also removed.
